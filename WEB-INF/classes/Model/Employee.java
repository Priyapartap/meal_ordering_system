...
public class Employee extends Connects
{
    /////Function for connect to the MySQL Server Database////////////
    public Employee()
    {
		Connects.connect_mysql();
    }
    //////////Save User Details /////
	...
	public String getStateOption(Integer SelID)
    {
    	...
    	return Connects.getOptionList("state","state_id","state_name","state_id,state_name",selectedID,"1");
    }
	/////Function for Getting the List////////////
	public String getEmployeeOption(Integer SelID)
    {
		int selectedID = SelID.intValue();
    	return Connects.getOptionList("employee","employee_id","employee_id","employee_id,employee_id",selectedID,"1");
    }
    /////Function for Getting the List////////////
	public String getRoleOption(Integer SelID)
    {
		int selectedID = SelID.intValue();
    	return Connects.getOptionList("roles","role_id","role_title","role_id,role_title",selectedID,"1");
    }
	/////Function for Getting the List////////////
	public String getCountryOption(Integer SelID)
    {
		int selectedID = SelID.intValue();
    	return Connects.getOptionList("country","country_id","country_name","country_id,country_name",selectedID,"1");
    }	
    ...
    {
		int selectedID = SelID.intValue();
    	return Connects.getOptionList("salutions","sl_id","sl_name","sl_id,sl_name",selectedID,"1");
    }	
    ...
    {
		int selectedID = SelID.intValue();
    	return Connects.getOptionList("status","status_id","status_name","status_id,status_name",selectedID,"1");
    }
    ...
    {
		int selectedID = SelID.intValue();
    	return Connects.getOptionList("department","dept_id","dept_name","dept_id,dept_name",selectedID,"1");
    }
