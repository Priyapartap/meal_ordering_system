...
<head>
	...
	<link href="layout/styles/custom_layout.css" rel="stylesheet" type="text/css" media="all">
...
<div class="wrapper row1">
	<header id="header" class="clear">
		<div id="logo" class="fl_left">
			<div style="float:left; margin-top:-11px;"><h1 style="font-size:36px;"><a href="index.jsp">Meal Ordering System</a></h1>
				<p style="color:#ffffff">For tiny businesses</p>
			</div>
		</div>
	</header>
</div>
